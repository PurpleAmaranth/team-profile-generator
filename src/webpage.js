...
const generateTeam = team => {
    ...
    <div class="card-header">
        ...
        <h3 class="card-title"><i class="fas fa-user-astronaut mr-2"></i>${intern.getRole()}</h3>
    </div>
    <div class="card-body">
        <ul class="list-group">
...
<head>
    ...
    <script src="https://kit.fontawesome.com/38a5bf3056.js" crossorigin="anonymous"></script>
